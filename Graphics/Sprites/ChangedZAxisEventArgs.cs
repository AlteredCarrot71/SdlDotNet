...
namespace SdlDotNet.Graphics.Sprites
{
    ...
    /// </summary>
    public class ChangedZAxisEventArgs : UserEventArgs
    {
        ...
        /// Constructor
        /// </summary>
        public ChangedZAxisEventArgs(Sprite sprite, ListSortDirection listSortDirection)
        {
            this.sprite = sprite;
        ...
        /// Constructor
        /// </summary>
        public ChangedZAxisEventArgs(Sprite sprite)
        {
            this.sprite = sprite;
